...
?>
	...
	<div class="addtocart-area">
		<form method="post" class="product js-recalculate" action="<?php echo JRoute::_ ('index.php?option=com_virtuemart',false); ?>">
			...
			echo '<div class="custom-fields-panel" id="product'.$modsa.$product->virtuemart_product_id.'"><a href="JavaScript:;" class="close-advanced-fields" onclick="toggle_visibility(\'product'.$modsa.$product->virtuemart_product_id.'\');">&times;</a>';
