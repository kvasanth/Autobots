...
if ($show_product_list) {
	?>
	<div class="show-cart"><a id="cartpanel" class="cart-button open-cart-panel-button" href="javascript:void(0);" title="<?php echo JText::_('COM_VIRTUEMART_CART_SHOW') ?>"><i class="fa fa-shopping-basket" aria-hidden="true"></i>
	<span class="products-number"><div class="total_products"><?php echo $data->totalProductTxt ?></div></span></a></div>

	<div class="<?php if($templateparams->get('carttype') == "sidepanel"): ?>panel2<?php elseif($templateparams->get('carttype') == "popupwindow"): ?>panel1<?php endif; ?>" id="cart-panel2">
		<div class="cartpanel">
